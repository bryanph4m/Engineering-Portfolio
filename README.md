...
```sh
curl -H "x-admin-key: $ADMIN_SECRET" https://<site>/api/bookings
curl -X POST -H "x-admin-key: $ADMIN_SECRET" -H "Content-Type: application/json" \
  -d '{"bookingId":"..."}' https://<site>/api/cancel
```
